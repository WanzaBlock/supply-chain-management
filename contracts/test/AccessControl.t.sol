...
contract AccessControlTest is Test {
    ...
    function test_AssignRoleEmitsEvent() public {
        ...
        emit RoleAssigned(alice, access.MANUFACTURER());
        access.assignRole(alice, access.MANUFACTURER());
    }
